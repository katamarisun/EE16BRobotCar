...
{  
  if(do_loop){
    ...
    if(count < SIZE){
      ...
      left_cur_pwm = (v_star + beta_left) / (theta_left) - k_left/(theta_left) * delta;
      right_cur_pwm = (v_star + beta_right) / theta_right + k_right/theta_right * delta;
